  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Chat',                                            action: () => { store.setRightTab('chat'); store.openRightPanel() } },
        { label: 'Preview',                                         action: () => { store.setRightTab('preview'); store.openRightPanel() } },
        { label: 'Layout Settings',                                 action: () => { store.setRightTab('settings'); store.openRightPanel() } },
        { separator: true },
        ...
        { label: 'Toggle Right Panel',                               action: () => store.toggleRightPanel() },
        { separator: true },
